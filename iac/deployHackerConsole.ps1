...
Get-ChildItem $consoleRoot | Where-Object { $_.Name -notin @( "iac", "createdEntraIdUserSettings.json", "documentation" ) -and (-not $_.Name.EndsWith('.csv')) } | Compress-Archive -DestinationPath $zipPackagePath
